...
// eu quero falar com cada item da lista, então uso o .js-tabmenu com o "LI", tenho que chamar eles para modificar aqui no js
    ...
    if(tabMenu.length && tabConteudo.length) {
        ...
        function activeTab(index) {
            ...
            const direcao = tabConteudo[index].dataset.anime;   // aqui estou dizendo para o tabConteudo pegar o que tenha dentro do dataset 'anime'
            tabConteudo[index].classList.add('ativo', direcao); // aqui estou falando para adicionar a classe ativo e a constante direcao
        }
...
/// aqui é para fazer a animação de scroll suave, de clicar no menu e ele ir rolando o scroll até o ID
